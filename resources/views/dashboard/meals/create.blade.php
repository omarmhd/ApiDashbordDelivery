                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" class="form-control"  name="delivery_time" value="{{old('delivery_time')}}" placeholder="" >
                                        </div>
                                    </div>
                                </div>
                                <!--/span-->
                                    ...
                                    <div class="{{$arr?'':'display-hide'}} box-sweet">
                                        ...
                                        @else
                                            <div class="form-group px-10 box-sweet-child">
                                                ...
                                                <div class="col-md-3">
                                                    <input type="text" class="form-control"    name="sweet_price[]"   placeholder="السعر" >
                                        ...
                                        @endif
                                            ...
                                            <div class="form-group group-duplicate   display-hide">
                                                ...
                                                <div class="col-md-1">
                                                    <button   type="check"  class="btn btn-danger btn-remove"><i class="fa fa-trash"></i></button>
                                                </div>
                                            </div>
