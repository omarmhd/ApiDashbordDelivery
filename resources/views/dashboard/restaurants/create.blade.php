        ...
        <div class="col-md-12">
            <div class="portlet light bordered">
                ...
                <div class="portlet-body form">
                    <!-- BEGIN FORM-->
                    <form action="{{ route('restaurant.store') }}" method="post" class="form-horizontal"
                            ...
                            <div class="row">
                                    ...
                                    <div class="form-group @error('name') has-error @enderror">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" class="form-control" placeholder=""
                                                value="{{ old('name', $restaurant->name) }}" name="name">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group @error('address') has-error @enderror">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" class="form-control" placeholder=""
                                                value="{{ old('address', $restaurant->address) }}" name="address">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group @error('phone') has-error @enderror">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" class="form-control" placeholder=""
                                                value="{{ old('phone', $restaurant->phone) }}" name="phone">
                                    ...
                                    <div class="form-group @error('active') has-error @enderror">
                                        ...
                                        <div class="col-md-9">
                                            <select name="active" id="" class="form-control">
                                                <option {{ old('active', $restaurant->active) == '1' ? 'selected' : '' }}
                                                    value="1">فعال</option>
                                                <option {{ old('active', $restaurant->active) == '0' ? 'selected' : '' }}
                                    ...
                                    <div class="form-group @error('description') has-error @enderror">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" class="form-control" name="description"
                                                value="{{ old('description', $restaurant->description) }}" placeholder="">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
