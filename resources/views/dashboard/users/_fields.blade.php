            ...
            <div class="form-group">
                ...
                <div class="col-md-9">
                    <select class="form-control" name="gender">
                        <option {{ old('gender', $user->gender) == 'ذكر' ? 'selected' : '' }} value="ذكر"> ذكر
                        </option>
                        <option {{ old('gender', $user->gender) == 'انثى' ? 'selected' : '' }} value="انثى">انثى
                        </option>
                    </select>
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form-group">
                ...
                <div class="col-md-9">
                    <input type="text" class="form-control" value="{{ old('address', $user->address) }}"
                        name="address">
                </div>
            </div>
        </div>
