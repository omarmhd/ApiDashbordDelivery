        ...
        <div class="col-md-12">
            <div class="portlet light bordered">
                ...
                <div class="portlet-body form">
                    <!-- BEGIN FORM-->
                    <form action="{{route('driver.update',['driver'=>$driver->user_id])}}" method="post" class="form-horizontal"  enctype="multipart/form-data">
                        @csrf
                        @method('put')
                        <div class="form-body">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            ...
                                            <textarea name="notes" class="form-control"  id="" cols="30" rows="10">
