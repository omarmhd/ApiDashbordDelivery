                                    ...
                                    <div class="form-group @error('code') has-error @enderror">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" class="form-control" placeholder=""
                                                value="{{ old('code', $coupon->code) }}" name="code">
                                        </div>
                                    </div>
                                </div>
                                <!--/span-->
                                    ...
                                    <div class="form-group @error('ammount') has-error @enderror">
                                        ...
                                        <div class="col-md-9">
                                            <input type="number" min="1" class="form-control" placeholder=""
                                                value="{{ old('ammount', $coupon->ammount) }}" name="ammount">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                            ...
                                            <div class="mt-radio-inline">
                                                <label class="mt-radio">
                                                    <input type="radio" name="is_selected" value="0"
                                                        {{ old('is_selected', $coupon->is_selected) == 0 ? 'checked' : '' }}>
                                                    عام
                                                    <span></span>
                                                </label>
                                                <label class="mt-radio">
                                                    <input type="radio" name="is_selected" value="1"
                                                        id="show-is-selected"
                                                        {{ old('is_selected', $coupon->is_selected) == 1 ? 'checked' : '' }}>
                                                    مخصص
                                                    <span></span>
                                                </label>
                                            </div>
                                            ...
                                            <div class="mt-radio-inline">
                                                ...
                                                <label class="mt-radio">
                                                    <input type="radio" name="status" value="1"
                                                        {{ old('status', $coupon->status) == 1 ? 'checked' : '' }}> لا
                                                    <span></span>
                                                </label>
                                            </div>
                                        </div>
                            ...
                            <div class="row">
                                    ...
                                    <div class="form-group  @error('start_avilable_at') has-error @enderror">
                                        ...
                                        <div class="col-md-9">
                                            <input type="datetime-local" class="form-control" placeholder=""
                                                value="{{ old('start_avilable_at', $coupon->start_avilable_at) }}"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group  @error('end_avilable_at') has-error @enderror">
                                        ...
                                        <div class="col-md-9">
                                            <input type="datetime-local" class="form-control" placeholder=""
                                                value="{{ old('end_avilable_at', $coupon->end_avilable_at) }}"
                                                        ...
                                                        <td>
                                                            <label
                                                                ...
                                                                <input type="checkbox" class="checkboxes"
                                                                    ...
                                                                    @if (old('selected', $coupon->selected) !== null) @foreach (old('selected', $coupon->selected) as $selected)
